...
from rmf_task_msgs.msg import TaskType, Bookshelf
...
class TaskRequester:
    ...
    def __init__(self, argv=sys.argv):
        ...
        parser.add_argument('-bs', '--bookshelf_start', required=True,
                            type=str, help='Bookshelf start waypoint')
    ...
    def generate_task_req_msg(self):
        ...
        req_msg.description.task_type.type = TaskType.TYPE_BOOKSHELF

        bookshelf = Bookshelf()
        bookshelf.start_waypoint = self.args.bookshelf_start
        req_msg.description.bookshelf = bookshelf
    ...
    def main(self):
        ...
        print(f"\nGenerated bookshelf request: \n {req_msg}\n")
        self.node.get_logger().info("Submitting Bookshelf Request")
